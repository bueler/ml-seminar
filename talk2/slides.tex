...
\begin{itemize}
\item an explanation for why OGD$=$SGD is a \emph{good} ML training algorithm
...
\item quantitative regret bounds expose performance differences
    \begin{itemize}
    \item[$-$] different algorithms (e.g.~OGD vs FTL vs Adam vs AMSGrad)
...
\item D.~P.~Kingma \& J.~Ba (2014). \href{https://arxiv.org/abs/1412.6980}{\emph{Adam: A method for stochastic optimization}}, preprint arXiv:1412.6980.
    \begin{itemize}
    \scriptsize
    \item[$-$] claims $O(\sqrt{j})$ regret bound framework
    \end{itemize}
